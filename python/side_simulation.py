...
axs[0, 0].set_ylim(-.45, 0.03)
axs[0, 0].grid()
#grid on
axs[0, 0].add_patch(Rectangle((-(xcenter+w/2), -(ycenter+h/2)), w, h, fill=False))
#rectangle('Position',[-(xcenter+w/2) -(ycenter+h/2) w h])
...
# axis equal
#axis([-.25 .35 -.45 0.03])
axs[0, 1].set_xlim(-.25, .35)
axs[0, 1].set_ylim(-.45, 0.03)
axs[0, 1].grid()
#grid on
axs[0, 1].add_patch(Rectangle((-(xcenter+w/2), -(ycenter+h/2)), w, h, fill=False))
#rectangle('Position',[-(xcenter+w/2) -(ycenter+h/2) w h])
...
axs[1, 0].set_ylim(-.45, 0.03)
axs[1, 0].grid()
#grid on
axs[1, 0].add_patch(Rectangle((-(xcenter+w/2), -(ycenter+h/2)), w, h, fill=False))
#rectangle('Position',[-(xcenter+w/2) -(ycenter+h/2) w h])
...
# axis equal
#axis([-.25 .35 -.45 0.03])
axs[1, 1].set_xlim(-.25, .35)
axs[1, 1].set_ylim(-.45, 0.03)
axs[1, 1].grid()
#grid on
axs[1, 1].add_patch(Rectangle((-(xcenter+w/2), -(ycenter+h/2)), w, h, fill=False))
#rectangle('Position',[-(xcenter+w/2) -(ycenter+h/2) w h])
